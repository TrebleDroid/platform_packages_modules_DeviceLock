...
public final class UserPreferences {
    ...
    /**
     * Set the current lock task mode state.
     *
     * @param context Context used to get the shared preferences.
     ...
     *
     * @param context Context used to get the shared preferences.
     * @return True if lock task mode is set.
     */
    public static int getDeviceState(Context context) {
        return getSharedPreferences(context).getInt(KEY_DEVICE_STATE, 0);
    }
     ...
     */
    public static void setDeviceState(Context context, int state) {
        getSharedPreferences(context).edit().putInt(KEY_DEVICE_STATE, state).apply();
    }

    /**
     * Get the name of the package overriding home.
     *
     * @param context Context used to get the shared preferences.
    ...
    /**
     * Set the name of the package overriding home.
     *
     * @param context Context used to get the shared preferences.
    ...
    /**
     * Get the list of packages allowlisted in lock task mode.
     *
     * @param context Context used to get the shared preferences.
    ...
    /**
     * Set the list of packages allowlisted in lock task mode.
     *
     * @param context Context used to get the shared preferences.
    ...
    public static void setLockTaskAllowlist(Context context, ArrayList<String> allowlist) {
        final Set<String> allowlistSet = new HashSet<>(allowlist);
