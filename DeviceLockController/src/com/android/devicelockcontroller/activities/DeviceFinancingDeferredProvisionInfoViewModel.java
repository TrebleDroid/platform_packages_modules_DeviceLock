 ...
 * financing use case.
 */
public class DeviceFinancingDeferredProvisionInfoViewModel extends ProvisionInfoViewModel {
    ...
    private static final int SUBHEADER_TEXT_ID = R.string.enroll_your_device_subheader;
